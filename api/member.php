...
class MemberManager {
    ...
    public function saveMember($data) {
        ...
        $required_fields = ['nama', 'whatsapp', 'email', 'alamat', 'kegiatan', 'jenisKartu', 'tanggalBerlaku'];
        ...
        $stmt->bind_param("sssssisss", $nama, $whatsapp, $email, $alamat, $umur, $kegiatan, $jenis_kartu, $kode_unik, $tanggal_berlaku);
